...
const Input = ({ label, type = "text", value, onChange, placeholder }) => (
  <div className="flex flex-col gap-1">
    ...
    className={`w-full max-w-full px-3 py-2 border border-gray-600 bg-gray-900/70 text-gray-100 placeholder-gray-500 focus:ring-2 focus:ring-yellow-500 focus:outline-none transition
        ${type === "date" ? "appearance-auto text-sm rounded-sm" : "rounded-md"} 
    `}
    />
